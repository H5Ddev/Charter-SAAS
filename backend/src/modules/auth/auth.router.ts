...
authRouter.post('/mfa/setup/verify', requireAuth, controller.mfaSetupVerify.bind(controller))
authRouter.post('/mfa/disable', requireAuth, controller.mfaDisable.bind(controller))
authRouter.post('/password-reset/request', controller.passwordResetRequest.bind(controller))
authRouter.post('/password-reset/confirm', controller.passwordResetConfirm.bind(controller))
