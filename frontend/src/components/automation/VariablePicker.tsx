...
const VARIABLES = [
  ...
  { path: 'trip.pilots', type: 'STRING', description: 'Pilot names', example: 'Capt. James Wilson, FO Sarah Lee' },
  { path: 'trip.returnTime', type: 'DATETIME', description: 'Return flight time', example: '5:00 PM' },
  { path: 'trip.returnPilots', type: 'STRING', description: 'Return flight pilot names', example: 'Capt. James Wilson' },
  { path: 'trip.returnFbo', type: 'STRING', description: 'Return FBO name', example: 'Signature Flight Support' },
